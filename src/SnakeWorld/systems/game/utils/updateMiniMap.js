const updateMiniMap = (gameState, miniMap) => {
  ...
  miniMapContext.fillRect(50, 50, 100, 100);
  ...
  miniMapContext.beginPath();
  miniMapContext.moveTo(0, 75); // Move pen to bottom-left corner
  miniMapContext.lineTo(25, 95); // Line to top corner
  miniMapContext.lineTo(20, 95); // Line to top corner
  miniMapContext.lineTo(20, 135); // Line to top corner
  miniMapContext.lineTo(0, 135); // Line to top corner
  miniMapContext.closePath(); // Line to bottom-left corner
  miniMapContext.fill();
